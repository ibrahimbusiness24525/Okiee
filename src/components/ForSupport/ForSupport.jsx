  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', maxWidth: '1200px', margin: '0 auto', backgroundColor: '#f8f9fa', padding: '20px' }}>
      ...
      <div style={{
        ...
        <h2 style={{ textAlign: 'center', marginBottom: '30px', color: '#2c3e50' }}>How Okiiee can help you?</h2>
        ...
        <div style={{ 
          ...
          {['Shop Profile Setup', 'Inventory Management', 'Sales Dashboard', 'Invoices Generation', 'Payment Methods', 'Support and Troubleshooting'].map((issue, index) => (
            <button
              key={index}
      ...
      <div style={{
        ...
        <h3 style={{ textAlign: 'center', color: '#2c3e50' }}>Submit Your Mail To Okiiee</h3>
