...
const BulkPhoneDetail = () => {
  ...
  const [responsiveStyles, setResponsiveStyles] =
    useState(getResponsiveStyle());
  ...
  return (
    <div style={responsiveStyles.container}>
          ...
          <div style={styles.flexRow}>
            ...
            <div>
              ...
              <p style={styles.value}>
                {purchaseData?.purchasePaymentType
                  ? purchaseData.purchasePaymentType.charAt(0).toUpperCase() +
                    purchaseData.purchasePaymentType.slice(1)
                  : 'N/A'}
              </p>
            </div>
          </div>
            ...
            <div>
              ...
              <p
                style={{
                  ...styles.value,
                  color:
                    purchaseData?.purchasePaymentStatus === 'paid'
                      ? '#059669'
                      : '#d97706',
                }}
              >
                {purchaseData?.purchasePaymentStatus
                  ? purchaseData.purchasePaymentStatus.charAt(0).toUpperCase() +
                    purchaseData.purchasePaymentStatus.slice(1)
                  : 'N/A'}
              </p>
            </div>
          </div>
          ...
          {purchaseData?.prices && (
            <>
              <div style={styles.statCard}>
                ...
                >
                  {formatCurrency(
                    Number(purchaseData.prices.buyingPrice) +
                      Number(
                        purchaseData?.creditPaymentData?.payableAmountLater
                      )
                  )}
                </p>
              </div>
      ...
      {purchaseData?.purchasePaymentType === 'credit' &&
        purchaseData?.creditPaymentData && (
          <div style={styles.card}>
              ...
              >
                <div style={styles.configHeader}>
                  <h3 style={styles.configTitle}>
                    ...
                    {config?.companyName} = {config.modelName} ={' '}
                    {config.ramMemory}GB RAM = {config.simOption}
                ...
                <div style={{ padding: '1rem' }}>
                  <div
                    style={{ ...styles.flexBetween, marginBottom: '0.75rem' }}
                  >
                  ...
                  >
                    ...
                    <span style={styles.value}>
                      {formatCurrency(config.priceOfOne)}
                    </span>
                  </div>
                  ...
                  {config.imeiNumbers && config.imeiNumbers.length > 0 && (
                    <div style={{ marginTop: '1rem' }}>
                      ...
                      >
                        <FaSimCard style={{ marginRight: '0.5rem' }} /> IMEI
                        Numbers
                      </h4>
                      <div style={styles.imeiContainer}>
                        {config.imeiNumbers
                          .filter((imei) => imei.status !== 'Sold')
                          .map((imei, imeiIndex) => (
                            <div
