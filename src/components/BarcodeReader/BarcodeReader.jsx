...
import { FiCopy, FiCamera, FiEdit3 } from "react-icons/fi";

const BarcodeReader = ({ onScan }) => {
  const [imeiNumber, setImeiNumber] = useState("No Scanned Yet");
  ...
  return (
    <div style={styles.container}>
      ...
      >
        <FiEdit3 style={styles.cameraIcon} />
        Enter Manually
      </button>
      ...
      {showConfirmation && (
        <div style={styles.confirmationBox}>
          ...
          <div style={styles.confirmationButtons}>
            <button onClick={handleManualConfirm} style={styles.confirmButton}>
              Yes
            </button>
      ...
      {isManualEntry && (
        <div style={styles.manualEntryContainer}>
          ...
          <button
            onClick={() => {
              setImeiNumber(manualIMEI);
              if (onScan) onScan(manualIMEI);
