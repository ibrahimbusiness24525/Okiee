  ...
  return (
    <>
      <Modal
        ...
        onHide={handleSinglePhoneModalclose}
        centered
        size="lg"
      >
        <Modal.Header closeButton>
          <Modal.Title style={{ textAlign: 'center', width: '100%' }}>
            {type === 'edit' ? 'Edit Phone' : 'Purchase Phone Slip'}
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form onSubmit={handleSubmit}>
            ...
            >
              <Form.Group
                controlId="purchasePhoneCompany"
                style={{ width: '48%' }}
              >
                <Form.Label style={{ fontWeight: 'bold', fontSize: '18px' }}>
                  Company
                ...
                <Form.Group controlId="purchasePhoneWarranty">
                  ...
                  >
                    ...
                    {[...Array(12).keys()].map((month) => (
                      <option
                        key={month}
                        value={`${month + 1} Month${month + 1 > 1 ? 's' : ''}`}
                      >
            ...
            >
              <Form.Group controlId="Ram/Memory" style={{ width: '48%' }}>
                ...
                <Form.Control
                  value={singlePurchase.ramMemory}
                  name="ramMemory"
                  onChange={handleChange}
                  type="text"
            ...
            {/* <div style={{ marginTop: '15px', lineHeight: '2.0' }}>
              <p style={{ fontSize: '17px' }}>
                ...
                نہیں ہے۔ اگر ایسا پایا گیا تو اس کا میں خود ذمہ دار ہوں گا اور
                اس سے ہونے والے تمام نقصانات کا ازالہ خود کروں گا۔
              </p>
              <p style={{ fontSize: '17px' }}>
            ...
            >
              ...
              >
                ...
                <Form.Control
                  value={singlePurchase.mobileNumber}
                  name="mobileNumber"
                  onChange={handleChange}
                  type="text"
            ...
            <div style={{ marginTop: '15px' }}>
              <Form.Label style={{ fontWeight: 'bold', fontSize: '15px' }}>
                To Show on Available Phones (Optional)
              </Form.Label>
              <Row>
                <Col>
            ...
            <Col style={{ marginTop: '10px' }}>
              <Form.Group controlId="bulkPayment">
                ...
                <Form.Select
                  value={singlePurchase.paymentType}
                  onChange={(e) =>
                    setSinglePurchase({
                      ...singlePurchase,
            ...
            {singlePurchase.paymentType === 'credit' && (
                ...
                <Col>
                  <Form.Group controlId="payableAmountNow">
                    ...
                    <Form.Control
                      ...
                      value={singlePurchase.payableAmountNow}
                      onChange={(e) =>
                        setSinglePurchase({
                          ...singlePurchase,
                ...
                <Col>
                  <Form.Group controlId="payableAmountLater">
                    ...
                    <Form.Control
                      type="number"
                      placeholder="Enter Payable Amount Now"
                      value={singlePurchase.payableAmountLater}
                      onChange={(e) =>
                        setSinglePurchase({
                          ...singlePurchase,
                ...
                <Col>
                  <Form.Group controlId="payableAmountLater">
                    ...
                    <Form.Control
                      ...
                      value={singlePurchase.paymentDate}
                      onChange={(e) =>
                        setSinglePurchase({
                          ...singlePurchase,
      ...
      <Modal
        toggleModal={() => setShowBankModal(!showBankModal)}
        size="md"
        show={showBankModal}
      >
      ...
      >
        <div style={{ padding: '20px', textAlign: 'center' }}>
          ...
          <Form.Group
            controlId="purchasePhoneFinalPrice"
