...
const DashDefault = () => {
  ...
  <Card style={{ marginTop: 25, backgroundColor: "#3f4d67", padding: 20, textAlign: "center" }}>
    ...
    <p>
      ...
      cutting-edge mobile software solutions tailored for individuals and businesses. 
      Our focus is on intuitive design, top-notch performance, and exceptional user experience.
    </p>

    <h5 style={{ marginTop: 30 }}>Contact Information</h5>
    <ul style={{ listStyleType: "none", padding: 0 }}>
      <li>
        <strong>Phone Name:</strong> MobileSoft Pro Max
      </li>
      <li>
        ...
        <a
          ...
          style={{ color: "#00796b", textDecoration: "none", fontWeight: "bold" }}
        >
      ...
      <li>
        ...
        <a
          href="https://www.mobilesoftsolutions.com"
          target="_blank"
          rel="noopener noreferrer"
          style={{ color: "#00796b", textDecoration: "none", fontWeight: "bold" }}
        >
          www.mobilesoftsolutions.com
        </a>
      </li>
    </ul>
  </Card>
